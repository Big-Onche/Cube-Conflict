...
namespace ai
{
    ...
    const float VIEWMIN         = 130.f;   // minimum field of view
    const float VIEWMAX         = 210.f;   // maximum field of view
    ...
    extern bool cansee(gameent *d, aistate &b, vec &x, vec &y, vec &targ = aitarget);
