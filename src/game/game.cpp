...
namespace game
{
    ...
    void updateworld()        // main game update loop
    {
        ...
        int nbmove = 1;
        if(nbfps<30) nbmove = 5; //Permet d'éviter que l'animation ne soit trop lente en cas de framerate bas, y'a surement moyen de faire mieux mais ça fait le taff pour l'instant
        else if(nbfps<60) nbmove = 3;
        else if(nbfps<100) nbmove = 2;
        ...
        loopi(nbmove)
        {
                if(zoom==1)
                {
                    ...
                    if(crosshairalpha<1.00f) crosshairalpha += 0.04f;
                }
                else
                {
                    ...
                    if(crosshairalpha>=0.04f) crosshairalpha -= 0.04f;
                }
        }
    ...
    void killed(gameent *d, gameent *actor)
    {
        ...
        else if(isteam(d->team, actor->team)) // Tir allié /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        {
            ...
            else if(d==player1) conoutf(contype, "\f6%s got fragged by a teammate (%s)", dname, aname); //TU as été tué par un allié
            else conoutf(contype, "\f2%s fragged a teammate (%s)", aname, dname); //Quelqu'un a tué un de ses alliés
        }
        else // Kill ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        {
