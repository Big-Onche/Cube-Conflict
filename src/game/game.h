...
static const struct attackinfo { int gun, action, picksound, sound, middistsnd, fardistsnd, specialsounddelay, attackdelay, damage, spread, nozoomspread, margin, projspeed, kickamount, range, rays, hitpush, exprad, ttl, use; } attacks[NUMATKS] =
{
    ...
    { GUN_PULSE,        ACT_SHOOT, S_WPLOADFUTUR,     S_PLASMARIFLE,  S_PLASMARIFLE_FAR,  S_FAR_LIGHT, 25,   90,  180,  45, 135, 0, 1500,   5, 8000,  1,    50,  25, 0, 1},
    { GUN_SMAW,         ACT_SHOOT, S_WPLOADBIG,       S_SMAW,         S_SMAW_FAR,                  -1,  3, 1250,  850,  20,  60, 2,  600,  15, 8000,  1,   750, 125, 0, 1},
    { GUN_MINIGUN,      ACT_SHOOT, S_WPLOADMID,       S_MINIGUN,      S_MINIGUN_FAR,      S_FAR_LIGHT, 35,   60,  180,  60, 180, 0, 3500,   5, 8000,  1,    15 ,  7, 0, 1},
    { GUN_SPOCKGUN,     ACT_SHOOT, S_WPLOADALIEN,     S_SPOCKGUN,     S_SPOCKGUN_FAR,     S_FAR_LIGHT, 15,  175,  250,  15, 150, 3, 1750,   5, 8000,  1,    30,  15, 0, 1},
    ...
    { GUN_UZI,          ACT_SHOOT, S_WPLOADSMALL,     S_UZI,          S_UZI_FAR,          S_FAR_LIGHT, 35,   75,  150,  50, 150, 0, 3000,   2, 8000,  1,    10,   5, 0, 1},
    { GUN_FAMAS,        ACT_SHOOT, S_WPLOADSMALL,     S_FAMAS,        S_FAMAS_FAR,        S_FAR_LIGHT, 30,   90,  140,  40, 120, 0, 3500,   3, 8000,  1,    20,   5, 0, 1},
    ...
    { GUN_SV98,         ACT_SHOOT, S_WPLOADMID,       S_SV98,         S_SV98_FAR,         S_FAR_HEAVY,  2, 1500,  900,   1, 200, 0, 4500,  30, 8000,  1,    80,   7, 0, 1},
    { GUN_SKS,          ACT_SHOOT, S_WPLOADMID,       S_SKS,          S_SKS_FAR,          S_FAR_HEAVY, 10,  420,  500,   5, 125, 0, 3500,  25, 8000,  1,    50,   7, 0, 1},
    { GUN_ARBALETE,     ACT_SHOOT, S_WPLOADMID,       S_CROSSBOW,     S_CROSSBOW_FAR,              -1,  5,  900,  850,  10,  90, 0, 2000,   7, 8000,  1,    20,   3, 45000, 1},
    { GUN_AK47,         ACT_SHOOT, S_WPLOADMID,       S_AK47,         S_AK47_FAR,         S_FAR_LIGHT, 30,   92,  170,  60, 180, 0, 3000,   7, 8000,  1,    50,   5, 0, 1},
    { GUN_GRAP1,        ACT_SHOOT, S_WPLOADFUTUR,     S_GRAP1,        S_GRAP1_FAR,                 -1, 12,  200,  250,  30, 300, 3, 1500,  -4, 8000,  1,  -600,  20, 0, 1},
    { GUN_ARTIFICE,     ACT_SHOOT, S_WPLOADSMALL,     S_FIREWORKS,    S_FIREWORKS_FAR,             -1,  3, 1100,  900,  35, 200, 2, 1200,  35,  600,  1,   500,  80, 300, 1},
    { GUN_GLOCK,        ACT_SHOOT, S_WPLOADSMALL,     S_GLOCK,        S_GLOCK_FAR,        S_FAR_LIGHT, 10,  100,  280,   5, 150, 0, 2000,   7, 8000,  1,    30,   3, 0, 1},
    // Super armes
    { GUN_S_NUKE,       ACT_SHOOT, S_WPLOADBIG,       S_NUKE,         S_NUKE_FAR,             S_NUKE_FAR,    1, 3000,  3250,  20, 300, 2,  175,  10, 2000,  1,   400, 1500, 6000, 1},
    { GUN_S_GAU8,       ACT_SHOOT, S_WPLOADBIG,       S_GAU8,         -1,                             -1,   90,   14,   370, 150, 250, 3, 6000,   4, 8000,  1,    80,   20, 0, 1},
    { GUN_S_ROQUETTES,  ACT_SHOOT, S_WPLOADBIG,       S_MINIROCKETS,  S_MINIROCKETS_FAR, S_FAR_VERYHEAVY,   14,  170,  2000,  10, 300, 2,  700,   6, 8000,  1,   500,  100, 0, 1},
    { GUN_S_CAMPOUZE,   ACT_SHOOT, S_WPLOADBIG,       S_CAMPOUZE,     S_CAMPOUZE_FAR,    S_FAR_VERYHEAVY,    8,  500,   500,  50,  50, 5, 5000,   3, 8000, 10,   150,    8, 0, 1},
    // Armes corps à corps
    ...
    { GUN_ASSISTXPL,    ACT_SHOOT, S_WPLOADBIG,       S_EXPL_PARMOR,   S_EXPL_FAR, S_EXPL_FAR,   1,  220, 1500, 1, 1,  0, 1,  10,  50,  1, 100, 350, 5, 1},
