...
{
    //Armes "normales"
    { GUN_RAIL,         ACT_SHOOT, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_FELECTRIQUE,  S_FELECTRIQUE_LOIN, S_NULL,   10,  350,  325,  40, 100, 0,    0,  10, 8000,  1,    30,   0, 0, 0},
    { GUN_PULSE,        ACT_SHOOT, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_FUSILPLASMA,  S_FPLASMA_LOIN, S_NULL,       25,  120,  180,  70, 200, 0, 1000,   5, 8000,  1,    50,  25, 0, 0},
    { GUN_SMAW,         ACT_SHOOT, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_SMAW,         S_LANCEMISSILE_LOIN, S_NULL,   3, 1250,  850,  20, 200, 0,  600,  15, 8000,  1,   750, 125, 0, 0},
    { GUN_MINIGUN,      ACT_SHOOT, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_MINIGUN,      S_MINIGUN_LOIN, S_ARMESLOIN,  35,   70,  180, 120, 400, 0, 3000,   5, 8000,  1,    15 ,  7, 0, 0},
    { GUN_SPOCKGUN,     ACT_SHOOT, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_SPOCKGUN,     S_SPOCK_LOIN, S_NULL,         15,  250,  300,  30, 150, 0, 1500,   5, 8000,  1,    30,  15, 0, 0},
    { GUN_M32,          ACT_SHOOT, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_LANCEGRENADE, S_LANCEGRENADE_LOIN, S_NULL,   3, 1000, 1250,  25, 250, 0,  400,  10, 1000,  1,   600, 160, 1000, 0},
    { GUN_LANCEFLAMMES, ACT_SHOOT, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_FLAMEATTACK,  S_NULL, S_NULL,               30,  100,   20, 500, 250, 0,    0,   2,  280, 10,    10 ,  0, 0, 0},
    { GUN_UZI,          ACT_SHOOT, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_UZI,          S_UZI_LOIN, S_ARMESLOIN,      35,   75,  150, 130, 300, 0, 3000,   2, 8000,  1,    10,   5, 0, 0},
    { GUN_FAMAS,        ACT_SHOOT, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_FAMAS,        S_FAMAS_LOIN, S_ARMESLOIN,    30,   90,  140, 100, 250, 0, 3000,   3, 8000,  1,    20,   5, 0, 0},
    ...
    { GUN_SV98,         ACT_SHOOT, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_SV98,         S_SV98_LOIN, S_RIFLELOIN,      2, 1500,  900,   1, 600, 0, 3000,  30, 8000,  1,    80,   7, 0, 0},
    ...
    { GUN_ARBALETE,     ACT_SHOOT, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_ARBALETE,     S_NULL, S_NULL,                5,  900,  850,  15, 200, 0, 1500,   7, 8000,  1,    20,   3, 0, 0},
    { GUN_AK47,         ACT_SHOOT, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_AK47,         S_AK47_LOIN, S_ARMESLOIN,     30,   92,  170, 125, 300, 0, 3000,   7, 8000,  1,    50,   5, 0, 0},
    { GUN_GRAP1,        ACT_SHOOT, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_GRAP1,        S_NULL, S_NULL,               12,  200,  250,  30, 400, 0, 1500,  -4, 8000,  1,  -600,  20, 0, 0},
    { GUN_ARTIFICE,     ACT_SHOOT, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_ARTIFICE,     S_ARTIFICE_LOIN, S_NULL,       3, 1100,  800,  50, 600, 0,  900,  45,  520,  1,   500,  80, 0, 0},
    { GUN_GLOCK,        ACT_SHOOT, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_GLOCK,        S_GLOCK_LOIN, S_ARMESLOIN,    10,  400,  280, 175, 350, 0, 2000,   7, 8000,  1,    30,   3, 0, 0},
    // Super armes
    { GUN_S_NUKE,       ACT_SHOOT, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_NUKELAUNCH,   S_NULL, S_NULL,                1, 3000,  3000,  20, 300, 0,  175,  10, 2000,  1,   400, 1350, 0, 0},
    { GUN_S_GAU8,       ACT_SHOOT, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_GAU8,         S_RIFLELOIN, S_RIFLELOIN,     90,   13,   350, 150, 250, 0, 4000,   1, 8000,  1,    80,   15, 0, 0},
