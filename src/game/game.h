...
static const struct attackinfo { int gun, action, anim, vwepanim, hudanim, sound, farsound1, farsound2, specialsounddelay, attackdelay, damage, spread, nozoomspread, margin, projspeed, kickamount, range, rays, hitpush, exprad, ttl, use; } attacks[NUMATKS] =
{
    ...
    { GUN_LANCEFLAMMES, ACT_SHOOT, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_FLAMEATTACK,  S_NULL, S_NULL,               30,  100,   20, 500, 500, 9,    0,   2,  280, 10,    10 ,  0, 0, 0},
    ...
    { GUN_HYDRA,        ACT_SHOOT, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_HYDRA,        S_HYDRA_LOIN, S_RIFLELOIN,     4,  315,   28, 300, 300, 0,    0,  15,  600, 15,    20,   0, 0, 0},
    ...
    { GUN_ARTIFICE,     ACT_SHOOT, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_ARTIFICE,     S_ARTIFICE_LOIN, S_NULL,       3, 1100,  800,  35, 200, 0, 1200,  45,  520,  1,   500,  80, 500, 0},
