...
enum
{
    ...
    N_DIED, N_DAMAGE, N_VAMPIRE, N_REAPER, N_VIKING, N_PRIEST, N_AFTERBURN, N_LAVATOUCH, N_LAVATOUCHFX, N_WATERTOUCH, N_HITPUSH, N_SHOTFX, N_EXPLODEFX,
...
static const int msgsizes[] =               // size inclusive message token, 0 for variable or not-checked sizes
{
    ...
    N_DIED, 7, N_DAMAGE, 8, N_VAMPIRE, 4, N_REAPER, 4, N_VIKING, 3, N_PRIEST, 3, N_AFTERBURN, 3, N_LAVATOUCH, 1, N_LAVATOUCHFX, 2, N_WATERTOUCH, 2, N_HITPUSH, 7, N_SHOTFX, 10, N_EXPLODEFX, 4,
