...
static const struct attackinfo { int gun, action, anim, vwepanim, hudanim, sound, hudsound, farsound1, farsound2, attackdelay, damage, spread, nozoomspread, margin, projspeed, kickamount, range, rays, hitpush, exprad, ttl, use; } attacks[NUMATKS] =
{
    ...
    { GUN_LANCEFLAMMES, ACT_SHOOT, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_FLAMEATTACK,  S_FLAMEATTACK,  S_NULL, S_NULL,                 100,   30, 500, 250, 0,    0,   2,  280, 10,    10 ,  0, 0, 0},
    ...
    { GUN_MOSSBERG,     ACT_SHOOT, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_MOSSBERG,     S_MOSSBERG,     S_MOSSBERG, S_RIFLELOIN,       1200,   50, 500, 500, 0,    0,  20, 1000, 25,    20,   0, 0, 0},
    { GUN_HYDRA,        ACT_SHOOT, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_HYDRA,        S_HYDRA,        S_HYDRA_LOIN, S_RIFLELOIN,      750,   20, 300, 300, 0,    0,  15,  520, 15,    20,   0, 0, 0},
