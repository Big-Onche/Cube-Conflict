...
namespace game
{
    void drawmessages(int killstreak, string str_pseudovictime, int n_aptitudevictime, string str_pseudoacteur, int n_killstreakacteur)
    {
        ...
        if(totalmillis-message1<=2500)
        {
            ...
            switch(n_aptitudevictime)
            {
                case 0: copystring(straptitudevictime, "\f4(Soldat)"); break;
                case 1: copystring(straptitudevictime, "\f4(Médecin)"); break;
                case 2: copystring(straptitudevictime, "\f4(Américain)"); break;
                case 3: copystring(straptitudevictime, "\f4(Ninja)"); break;
                case 4: copystring(straptitudevictime, "\f4(Vampire)"); break;
                case 5: copystring(straptitudevictime, "\f4(Magicien)"); break;
                case 6: copystring(straptitudevictime, "\f4(Kamikaze)"); break;
                case 7: copystring(straptitudevictime, "\f4(Faucheuse)"); break;
                case 8: copystring(straptitudevictime, "\f4(Physicien)"); break;
                case 9: copystring(straptitudevictime, "\f4(Campeur)"); break;
                case 10: copystring(straptitudevictime, "\f4(Commando)"); break;
                case 11: copystring(straptitudevictime, "\f4(Prêtre)"); break;
                case 12: copystring(straptitudevictime, "\f4(Viking)"); break;
                case 13: copystring(straptitudevictime, "\f4(Dealer)"); break;
                default: copystring(straptitudevictime, ""); break;
            }
        ...
        if(totalmillis-message2<=2500)
        {
            ...
            draw_textf("Tu as tué \fc%s \f7! %s",  x, y-385+decal_message, str_pseudovictime, straptitudevictime);
            decal_message = decal_message - 50;
        }
    ...
    */
    ...
    void gameplayhud(int w, int h)
    {
        ...
        {
            gle::colorf(viseurcol, viseurcol, viseurcol, viseurcol);
        ...
        {
            if(player1->health<=50) dodo = 0.6f;
            if(player1->health<=40) dodo = 0.7f;
            if(player1->health<=30) dodo = 0.8f;
            if(player1->health<=20) dodo = 0.9f;
            if(player1->health<=10) dodo = 1.0f;

            gle::colorf(dodo, dodo, dodo, dodo);
        ...
        {
            case GUN_SV98: zoomfov = 30; break;
            case GUN_ARBALETE: zoomfov = 45; break;
            case GUN_SKS: zoomfov = 50; break;
            case GUN_RAIL:
            case GUN_PULSE:
            case GUN_S_CAMPOUZE: zoomfov = 60; break;
            case GUN_SPOCKGUN:
            case GUN_AK47:
            case GUN_S_ROQUETTES:
            case GUN_FAMAS: zoomfov = 70; break;
            case GUN_MINIGUN:
            case GUN_UZI: zoomfov = 80; break;
            case GUN_SMAW:
            case GUN_ARTIFICE:
            case GUN_GRAP1:
            case GUN_GLOCK:
            case GUN_S_GAU8:
            case GUN_M32: zoomfov = 85; break;
            default: zoomfov = 90;
        }
        //if(player1-> gunselect == GUN_ARTIFICE)         {maxammo = m_sp ? maxmun_artifice : 40; zoomfov = 85; }
        //if(player1-> gunselect == GUN_MJAVLIN)          {maxammo = 60; zoomfov = 65; }
        //if(player1-> gunselect == GUN_ANTIMAT)          {maxammo = 280; zoomfov = 75; }
        //if(player1-> gunselect == GUN_CAMPOUZE)         {maxammo = 30; zoomfov = 40; }
        ...
        if(player1->state==CS_DEAD)
        {
            int pw, ph, tw, th, fh;
            text_bounds("  ", pw, ph);
            text_bounds("Tué par Superpseudo1234 (Américain)", tw, th);
            th = max(th, ph);
            fh = max(fh, ph);

            switch(n_aptitudetueur)
            {
                case 0: copystring(strclassetueur, "\f4(Soldat)"); break;
                case 1: copystring(strclassetueur, "\f4(Médecin)"); break;
                case 2: copystring(strclassetueur, "\f4(Américain)"); break;;
                case 3: copystring(strclassetueur, "\f4(Ninja)"); break;
                case 4: copystring(strclassetueur, "\f4(Vampire)"); break;;
                case 5: copystring(strclassetueur, "\f4(Magicien)"); break;
                case 6: copystring(strclassetueur, "\f4(Kamikaze)"); break;
                case 7: copystring(strclassetueur, "\f4(Faucheuse)"); break;
                case 8: copystring(strclassetueur, "\f4(Physicien)"); break;
                case 9: copystring(strclassetueur, "\f4(Campeur)"); break;
                case 10: copystring(strclassetueur, "\f4(Commando)"); break;
                case 11: copystring(strclassetueur, "\f4(Prêtre)"); break;
                case 12: copystring(strclassetueur, "\f4(Viking)"); break;
                case 13: copystring(strclassetueur, "\f4(Dealer)"); break;
                default: copystring(strclassetueur, ""); break;
            }
