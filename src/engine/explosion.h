...
static fireballrenderer fireballs("media/particle/explosion.png"), pulsebursts("media/particle/plasma.png"), ondedechoc("media/particle/ondechoc.png"), plasma("media/particle/grenade.png");;
