...
extern bool isUnderWater(vec pos);
...
extern void renderbackground(const char *caption = NULL, Texture *mapshot = NULL, const char *mapname = NULL, const char *tip = NULL, bool force = false);
...
// rendermodel
struct mapmodelinfo { string name; model *m, *collide; string lodname; model *mlod, *collidelod; };
