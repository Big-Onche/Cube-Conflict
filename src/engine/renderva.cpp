...
static inline void rendermapmodel(extentity &e)
{
    ...
    rendermapmodel(e.attr2, anim, e.o, e.attr1, e.attr3, e.attr5, MDL_CULL_VFC | MDL_CULL_DIST | MDL_CULL_OCCLUDED, basetime, e.attr4 > 0 ? e.attr4/100.0f : 1.0f);
}
...
void genshadowmeshes()
{
    ...
    renderprogress(0, "flood inutile...");
