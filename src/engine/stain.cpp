...
//rendermapmodel(e.attr2, anim, e.o, e.attr1, e.attr3, e.attr5, MDL_CULL_VFC | MDL_CULL_DIST, basetime, e.attr4 > 0 ? e.attr4/100.0f : 1.0f);
...
extern void setdecorationlod();
VARFP(decoration_lod, 0, 2, 4, {setdecorationlod();});

void setdecorationlod()
{
    switch(decoration_lod)
    {
        case 0:
            maxstaintris = 1024;
            stainfade = 15000;
