...
enum SoundFlags
{
    ...
    SND_UI            = 1 << 2,     // ui/notification sounds; bypass spatial EFX (reverb/occlusion)
...
extern void soundNearmiss(int sound, const vec &from, const vec &to, int precision = 1024);
