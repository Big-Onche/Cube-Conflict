...
static const struct achinfo { const char *achname, *achnicenameFR, *achnicenameEN, *achdescFR, *achdescEN; } achievements[NUMACHS] =
{
    ...
    {"ACH_FKYEAH",        "Fuck yeah !",                 "Fuck yeah!",                  "Tuer un Shoshone en étant Américain.",                                  "Kill a Shoshone with the American class."},
    ...
    {"ACH_EPOFLAG",       "C'est à ça que ça sert !",    "That's what it's made for!",  "Ramenez un drapeau ennemi en étant boosté par l'EPO.",                  "Bring back an enemy flag while being boosted by EPO."},
    ...
    {"ACH_FKYOU",         "Ils vont adorer !",           "They will love it!",          "Equiper la tombe \"fuck\".",                                            "Equip the grave \"fuck\"."},
