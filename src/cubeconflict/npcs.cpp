...
namespace game
{
    ...
    {   //weapon        sp. hea.  freq  lag  rate pain  trigdist. loy. size  weight  res. drop fri.   fly.  hellosnd.  painsnd.   angrysnd.  diesnd.     namefr             nameen              mdlldir              shielddir              hatdir             capedir             boost1dir        boost2dir
        { GUN_S_NUKE,   10, 5000, 0,    30,  5,   100,  100,      5,   12,   85,     1,   0,   true,  false,        -1,        -1,        -1,        -1, "Jean Onche",      "Jean Onche",       "smileys/hap/jo",    "shields/gold/100",    "hats/crown",      "capes/cape_elite", NULL,            NULL},
        { GUN_CACFLEAU, 15, 2500, 0,    30,  5,    50,  100,      5,   12,   90,     1,   0,   true,  false,        -1,        -1,        -1,        -1, "Bjorn",           "Bjorn",            "npcs/bjorn",        "shields/wood/60",     NULL,              NULL,               NULL,            NULL},
