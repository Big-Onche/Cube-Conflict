...
namespace game
{
    ...
    {   //weapon        sp. hea.  freq  lag  rate pain  trigdist. loy. size  weight  res. drop fri.  hellosnd.  painsnd.   angrysnd.  diesnd.     namefr             nameen              mdlldir              shielddir              hatdir             capedir             boost1dir        boost2dir
        ...
        { GUN_CACFLEAU, 15, 2500, 0,    30,  5,    50,  100,      5,   12,   90,     1,   0,   true,        -1,        -1,        -1,        -1, "Bjorn",           "Bjorn",            "npcs/bjorn",        "shields/wood/60",     NULL,              NULL,               NULL,            NULL},
        ...
        { GUN_ARTIFICE,  5, 1500, 0,    75, 10,    50,  100,      5,   10,   60,     1,   0,   true,        -1,        -1,        -1,        -1, "Spike",           "Spike",            "smileys/content",   NULL,                  NULL,              NULL,               "boosts/steros", "boosts/epo"},
        { GUN_ARBALETE, 20, 2000, 0,     5,  2,    25,  100,      5,    8,   70,     1,   0,   true,        -1,        -1,        -1,        -1, "Boing",           "Boing",            "smileys/fou/b",     NULL,                  "hats/3",          NULL,               NULL,            NULL},
        { GUN_MOSSBERG,  8, 2000, 0,     5,  2,    25,  100,      5,   12,   80,     1,   0,   true,        -1,        -1,        -1,        -1, "Sergent Fartman", "Sergeant Fartman", "smileys/colere/sh", NULL,                  "hats/green",      NULL,               NULL,            NULL},
        { GUN_RAIL,     10, 1500, 0,    15,  2,    50,  100,      5,   10,   80,     1,   0,   true,        -1,        -1,        -1,        -1, "Switch",          "Switch",           "smileys/sournois",  "shields/iron/100",    "hats/5",          NULL,               NULL,            NULL},
        { GUN_SMAW,      8, 1250, 0,    15,  2,    50,  100,      5,   10,   80,     1,   0,   true,        -1,        -1,        -1,        -1, "Larry",           "Larry",            "smileys/cool",      NULL,                  "hats/0",          NULL,               NULL,            NULL},
        { GUN_CAC349,    5,  500, 0,     5,  2,   150,  125,      1,    6,   40,     60,  0,   false,       -1,        -1,        -1,        -1, "un Kévin",        "a Moron",          "npcs/kevin",        "shields/bois/20",     NULL,              NULL,               NULL,            NULL},
        // DMSP
        ...
        { GUN_CACNINJA, 35, 1000, 0,     5,  2,     1,  150,      5,    8,   70,     90,  2,   false,       -1,                 -1,        -1,         -1, "un Ninja",        "a Ninja",          "smileys/fou/b",     NULL,                  "hats/3",          NULL,       "boosts/epo",            NULL},
        { GUN_S_ROQUETTES, 10, 5000, 0, 50, 50,     1,  300,     10,   20,  750,     60,  4,   false,       -1,                 -1,        -1,         -1, "un Géant",        "a Giant",          "smileys/content/g", "shields/gold/100",    "hats/8",          NULL,               NULL,            NULL},
        { GUN_SV98,      5,  600, 2,    30,  1,     1,  200,      1,   10,   85,     60,  2,   false,       -1,                 -1,        -1,         -1, "un campeur",      "a camper",         "smileys/bug",       NULL,                  "hats/9",          NULL,               NULL,            NULL},
        ...
        { GUN_LANCEFLAMMES, 18, 1000, 0, 0,  0,     1,  300,      1,   10,  100,     60,  2,   false,       -1,          S_ALIEN_P, S_ALIEN_A,  S_ALIEN_D, "un pyromane",     "an arsonist",      "smileys/sournois", "shields/iron/100",     "hats/8", "boosts/joint",              NULL,            NULL},
    };
