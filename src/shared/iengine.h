...
extern void particle_hud(int type, const vec &pos, int color, float size = 0.06f);
...
extern void playSound(int soundIndex, const vec *soundPos = NULL, float maxRadius = 300.f, float maxVolRadius = 10.f, int flags = NULL, extentity* owner = NULL);
