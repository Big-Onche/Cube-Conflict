...
extern const char *readstr(const char *ident, int at = 0);
...
extern void mpeditent(int i, const vec &o, int type, int attr1, int attr2, int attr3, int attr4, int attr5, int attr6, int attr7, int attr8, int attr9, bool local);
...
enum
{
    ...
    // flames and smokes
    PART_SMOKE, PART_SMOKE_S, PART_SMOKE_L, PART_FLAME, PART_FIRE_BALL, PART_FIRESPARK,
    // water
