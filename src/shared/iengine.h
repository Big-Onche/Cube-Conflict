...
enum
{
    ...
    PART_FLAME,
    PART_STREAK,
    PART_RAIL_TRAIL, PART_PULSE_SIDE, PART_PULSE_FRONT, PART_BALLE_SIDE, PART_IMPACT, PART_SPOCK_FRONT, PART_SANTE,
    PART_FLAME1, PART_FLAME2,
    PART_SNOW, PART_RAIN, PART_NUAGE1, PART_NUAGE2, PART_NUAGE3, PART_NUAGE4,
...
extern void moveplayer(physent *pl, int moveres, bool local, int epomillis, int jointmillis, int aptitude);
extern bool moveplayer(physent *pl, int moveres, bool local, int curtime, int epomillis, int jointmillis, int aptitude);
