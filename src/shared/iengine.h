...
extern void regularsplash(int type, int color, int radius, int num, int fade, const vec &p, float size, int gravity, int delay = 0, int expand = 0, bool upsplash = false);
