...
enum { DISC_NONE = 0, DISC_EOP, DISC_LOCAL, DISC_KICK, DISC_MSGERR, DISC_DESYNC, DISC_UNK, DISC_MSGERR_SERVMSG, DISC_MSGERR_EDIT, DISC_IPBAN, DISC_PRIVATE, DISC_MAXCLIENTS, DISC_TIMEOUT, DISC_OVERFLOW, DISC_PASSWORD, DISC_NUM, DISC_NORMAL };
