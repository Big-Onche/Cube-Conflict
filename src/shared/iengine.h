...
enum
{
    PART_BASIC = 0,
    // guns muzzle flashes
    PART_MF_LITTLE, PART_MF_BIG, PART_MF_ELEC, PART_MF_PLASMA, PART_MF_ROCKET, PART_MF_SHOTGUN, PART_MF_SNIPER,
    // bullets flares
    PART_F_BULLET, PART_F_SHOTGUN, PART_F_PLASMA, PART_SPOCK_FRONT, PART_PLASMA_FRONT,
    // flames and smokes
    ...
    // game specific
    PART_VISEUR, PART_ZERO, PART_ONE, PART_BLIP, PART_HEALTH, PART_MANA, PART_RADAR, PART_METER, PART_METER_VS,
    // explosions
