...
enum
{
    ...
    PART_FLAME1, PART_FLAME2, PART_EAU,
...
extern void particle_flying_flare(const vec &o, const vec &d, int fade, int type, int color, float size, int gravity = 0, int expand = 0);
...
extern void particle_splash(int type, int num, int fade, const vec &p, int color = 0xFFFFFF, float size = 1.0f, int radius = 150, int gravity = 2, int expand = 0);
