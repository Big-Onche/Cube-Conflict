...
namespace game
{
    ...
    extern void renderplayerpreview(int model, int cape, int color, int team, int weap);
    extern int numanims();
    ...
    extern void rendermessages(char *line, int y);
    extern void rendersoftmessages(int y);
    extern void dotime();
