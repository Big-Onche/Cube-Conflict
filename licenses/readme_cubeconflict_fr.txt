...
et le redistribuer librement, sous réserve des restrictions suivantes :

1. L'origine de ce logiciel ne doit pas être déformée; vous ne devez 
   pas prétendre que vous avez créé le logiciel original. 
   Si vous utilisez ce logiciel dans un produit, une reconnaissance dans la 
   documentation du produit serait appréciée mais n'est pas obligatoire.
...
3. Cette note ne peut être supprimée ou modifiée sur aucune distribution du logiciel.
